{
    ...
    function cacheSelectors(site) {
        ...
        switch(site) {
            ...
            case 'opentable':
                ...
                break;
            case 'grubhub':
                selectors.insertCardBeforeThisElement = document.querySelector('#navSection-menu > div.page-nav-container-placeholder');
                break;
            default:
    ...
    function getRestaurantInfo(selectors, site) {
        if (jsonLdSites.indexOf(site) >= 0) {
            console.log('scraping json ld');
            const scrapedData = scrapeJsonLd();
            //const scrapedData = schemaOrgParser();
        ...
        } else if (schemaOrgSites.indexOf(site) >= 0) {
            console.log(schemaOrgParser());
        } else {
            const restaurantInfo = {};
    ...
    function main() {
        ...
        try {
            ...
            restaurantInfo  = getRestaurantInfo({}, site);
        } catch (error) {
